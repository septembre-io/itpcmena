...
import { PublicationsUnified, OpEdChapter } from "@/components/v3/sections/OpEd";
import { OpEdDemoSwitcher } from "@/components/v3/sections/OpEdDemoSwitcher";
  ...
  return (
    <div className="bg-cream text-ink">
      ...
      <main>
        ...
        {/* ── ACTUALITÉS + OP-ED — démo de 2 dispositions (switcher flottant) ── */}
        <OpEdDemoSwitcher
          unified={<PublicationsUnified locale={locale} />}
          chapter={
            <>
              <NewsV2
                locale={locale}
